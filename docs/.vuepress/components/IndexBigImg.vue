  ...
  methods: {
    ...
    bgTimeColorAndTip() {
      ...
      if (hours >= 6 && hours < 8) {
        ...
        addTip(
          `早上好~~，现在是 ${hours}:${minutes}:${seconds}，吃早餐了吗？一日之计在于晨，给自己一个鼓励😊🤭`,
          "info",
          50,
          4000
        );
        ...
        div.style.backgroundColor = this.bgTimeColorArray[0];
        addTip(
          `上午好~~，现在是 ${hours}:${minutes}:${seconds}，紧张忙碌工作的你，好棒，我要给你一个大大的赞！👍🥤~~`,
          "info",
          50,
          4000
        );
        ...
        div.style.backgroundColor = this.bgTimeColorArray[0];
        addTip(
          `中午好~~，现在是 ${hours}:${minutes}:${seconds}，忙碌了一上午，记得吃中餐并适当休息下🥤🏀~~`,
          "info",
          50,
          4000
        );
        ...
        div.style.backgroundColor = this.bgTimeColorArray[0];
        addTip(
          `下午好~~，现在是 ${hours}:${minutes}:${seconds}，继续加油，努力工作的你简直帅呆了👍😊~~`,
          "info",
          50,
          4000
        );
        ...
        addTip(
          `晚上好~~，现在是 ${hours}:${minutes}:${seconds}，吃晚饭了吗？忙碌了一整天的你，要补充补充营养，休息休息🥗🍖~~`,
          "info",
          50,
          4000
        );
        ...
        addTip(
          `晚上好呀~~，现在是 ${hours}:${minutes}:${seconds}，还在加班，好心疼呢，那就加油赶快做吧，好早点下班👍👍👍~~`,
